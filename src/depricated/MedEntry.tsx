...
export default class MedEntry {
  ...
  getAmountInDate() {
    return this.isExpired() ? 0 : this.getAmountNumber();
  }
  ...
  render() {
    return <MedField key={this.id} entry={this} />;
  }
}
